...
public class FeatureHU16 {
  ...
  @Test
  public void test1_checkDeliveriesClient(){
    ...
    for (UiObject2 tv : allTextViews) {
      if (tv.getText() != null && tv.getText().trim().equals("VER DETALLES")) {
        tv.click();
        break;
      }
    }
    ...
    allTextViews = device.findObjects(By.clazz("android.widget.TextView"));
    for (UiObject2 tv : allTextViews) {
      if (tv.getText().equals("Tiempo estimado de llegada") || tv.getText().equals("PENDIENTE") || tv.getText().contains("Total"))  {
        textFound = true;
        break;
      }
    }
